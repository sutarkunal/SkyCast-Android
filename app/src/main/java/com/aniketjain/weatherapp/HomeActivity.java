...
public class HomeActivity extends AppCompatActivity {
    ...
    private ImageButton gpsBtn, mapBtn, modeBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (city != ""){
                    Intent intent= new Intent(HomeActivity.this, web.class);
                    intent.putExtra( "latitude", latitude);
                    intent.putExtra( "longitude", longitude);
                    startActivity(intent);
                }
                else {
                    Toast.makeText(HomeActivity.this, "Enter Correct City Name", Toast.LENGTH_SHORT).show();
                }
            }
        });
        modeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Mode=="Dark") {
                    ...
                    main.setBackgroundColor(getResources().getColor(R.color.lightBGColor));
                    srl.setBackgroundColor(getResources().getColor(R.color.lightBGColor));
                    Mode = "Light";
                }
                else {
                    ...
                    main.setBackgroundColor(getResources().getColor(R.color.mainBGColor));
                    srl.setBackgroundColor(getResources().getColor(R.color.mainBGColor));
                    Mode = "Dark";
                    // change text of Button
